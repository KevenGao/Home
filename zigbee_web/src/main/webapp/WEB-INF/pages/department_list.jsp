                        ...
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-refresh" onclick="javascript:window.location.href='/department/list';"></i>
                                </button>
                                <button type="button" class="btn btn-default light">
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="">
                            ...
                            <th class="text-center hidden-xs">部门编号</th>
                            <th class="text-center hidden-xs">部门名称</th>
                            <th class="text-center hidden-xs">地址</th>
                        ...
                        <c:forEach items="${list}" var="dept">
                            <tr class="message-unread">
                                ...
                                <td class="text-center">${dept.sn}</td>
                                <td class="text-center">${dept.name}</td>
                                <td class="text-center">${dept.address}</td>

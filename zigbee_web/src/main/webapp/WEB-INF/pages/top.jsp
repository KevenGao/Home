                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            %>
                            <div class="media-author">亲爱的：<%=name %>！欢迎您</div>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        ...
                        <span class="sidebar-title">家庭管理</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/employee/list">
                                <span class="glyphicon glyphicon-calendar"></span> 所有成员 </a>
                        </li>
                        <li class="active">
                            <a href="/employee/to_add">
                                <span class="glyphicon glyphicon-check"></span> 添加成员 </a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="/sensor/list">
                        ...
                        <span class="sidebar-title">房屋环境实时数据</span>
                        <span class="sidebar-title-tray">
                            <span class="label label-xs bg-primary">刷新</span>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="/error/list">
                        <span class="glyphicon glyphicon-book"></span>
                        <span class="sidebar-title">房屋环境异常数据</span>
                        <span class="sidebar-title-tray">
                            <span class="label label-xs bg-primary">刷新</span>
                        </span>
                    </a>
                ...
                <li>
                    <a href="/sensor/to_send">
                        <span class="glyphicon glyphicon-book"></span>
                        <span class="sidebar-title">设备控制管理</span>
                    </a>
                </li>
            </ul>

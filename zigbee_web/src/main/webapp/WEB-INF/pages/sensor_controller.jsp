...
<div class="text-center panel-footer panel-body bg-light">
    <a href="/sensor/send?request=08">
        <button name="on_light" type="button" id="light_btn" style="width: 80px;height:25px">灯光控制</button>
    </a>
</div>

<div class="text-center panel-footer panel-body bg-light">
    <a href="/sensor/send?request=01">
        <button name="on_light" type="button" id="fan_btn" style="width: 80px;height:25px">风扇控制</button>
    </a>
</div>
...
<div class="text-center panel-footer panel-body bg-light">
    <%--<a href="/sensor/send?request=00">--%>
        <button name="on_light" type="button" id="off_btn" style="width: 80px;height:25px">其他设备</button>

                ...
                <div class="panel mt30 mb25">
                    <form method="post" action="login" id="contact">
                        <div class="panel-body bg-light p25 pb15">
                            <div class="section">
                                ...
                                <label for="sn" class="field prepend-icon">
                                    <input type="text" name="sn" id="sn" class="gui-input" placeholder="请输入您的账号...">
                            ...
                            <div class="section">
                                ...
                                <label for="password" class="field prepend-icon">
                                    <input type="password" name="password" id="password" class="gui-input" placeholder="请输入您的密码...">
                        ...
                        <div class="panel-footer clearfix">
                            ...
                            <span> 没有账号？注册</span>
                            <%--<button type="submit" class="button btn-primary mr11 pull-right">没有账号？注册</button>--%>
